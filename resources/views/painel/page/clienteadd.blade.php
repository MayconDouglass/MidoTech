    ...
    <form class="form-horizontal" method="POST" action="{{action('ClienteController@store')}}">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-2">
          ...
          <p><input class="form-control" type="number" name="limitecred" id="limitecred" autocomplete="off" required></p>
        </div>
        ...
        <div class="col-sm-4">
          ...
          <p><input class="form-control" type="text" name="log" id="logradouro" maxlength="250" autocomplete="off"
              required></p>
        </div>

        <div class="col-sm-3">
          <label class="control-label">Complemento</label>
          <p><input class="form-control" type="text" name="complemento" id="complemento" maxlength="40"
              autocomplete="off"></p>
        </div>
